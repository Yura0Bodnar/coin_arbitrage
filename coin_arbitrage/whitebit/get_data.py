...
def get_whitebit_data(symbol, redis_key):
    try:
        ...
        url_ticker = f"https://whitebit.com/api/v4/public/ticker"
        ...
        logging.error(f"Error processing WhiteBit data for {symbol}: {e}. Response data: {data_orderbook if data_orderbook else 'N/A'}")
        sys.exit(1)
